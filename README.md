...
Traceback (most recent call last):
  ...
  File "C:\Users\h84609n\Desktop\AgenticAI\agents\retrieval_intelligence_agent.py", line 159, in run
    User Story: {state['user_story']}
                 ~~~~~^^^^^^^^^^^^^^
KeyError: 'user_story'
During task with name 'retrieval_agent' and id 'fd6bd3bb-374b-0bf4-69f3-60949475b586'
