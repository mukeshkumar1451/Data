...
Traceback (most recent call last):
  ...
  File "C:\Users\h84609n\Desktop\AgenticAI\agents\excel_export_agent.py", line 178, in run
    precondition = self._format_precondition(channel, setup_text)
  File "C:\Users\h84609n\Desktop\AgenticAI\agents\excel_export_agent.py", line 97, in _format_precondition
    loan_purpose = data["loan_purpose"]
                   ~~~~^^^^^^^^^^^^^^^^
KeyError: 'loan_purpose'
During task with name 'excel_agent' and id '98d8bc68-9edd-003f-7ac0-3396eb2df295'
